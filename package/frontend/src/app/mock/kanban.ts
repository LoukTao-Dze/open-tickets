...
export const MOCK_TICKET_META_ITEMS: KanbanMeta[] = [
  { icon: 'chat_bubble', label: 'Comments' },
  { icon: 'attach_file', label: 'Files' },
  { icon: 'history', label: 'Overdue' },
  { icon: 'bolt', label: 'Ready' },
  { icon: 'sync', label: 'In Review' },
  { icon: 'priority_high', label: 'High' },
...
export const MOCK_TICKETS: KanbanTicket[] = [
  {
    id: 'DS-1024',
    columnId: 'todo',
    ...
    meta: MOCK_TICKET_META_ITEMS.slice(0, 2),
    assigneeAvatarUrl:
